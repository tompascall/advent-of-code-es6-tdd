import Chars from './day08_chars';
let input = String.raw`"sjdivfriyaaqa\xd2v\"k\"mpcu\"yyu\"en"
"vcqc"
...
"ccxjgiocmuhf\"ycnh"
"lltj\"kbbxi"`;
//  let input = String.raw`"\\lcomf\\s"`;
//  console.log(input);
let chars = new Chars(input),
    counts = chars.counter();

console.log(`Bytes for code: ${counts.code}
Bytes for mem: ${counts.mem}
Their difference is: ${counts.code - counts.mem}`);

console.log(`Bytes for string if looking at the input as mem representation: ${counts.invert}
Bytes for code: ${counts.code}
Their difference is: ${counts.invert - counts.code}`);
