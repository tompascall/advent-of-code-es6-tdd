import wrapper from '../src/day02_wrapper_paper';

describe('test wrapper', () => {
  var a = 20, b = 11, c = 3;
  it('should calc wrapper paper for 1 box', () => {
    var boxDimensions = '20x3x11';
    expect(wrapper.calc(boxDimensions).paper).to.equal(2 * (a * c + c * b + a * b) + c * b);
  });

  it('should calc wrapper paper for more boxes', () => {
    var boxDimensions = '20x3x11\n20x3x11';
    expect(wrapper.calc(boxDimensions).paper).to.equal(2 * (2 * (a * c + c * b + a * b) + c * b));
  });
